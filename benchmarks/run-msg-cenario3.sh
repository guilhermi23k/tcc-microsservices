#!/usr/bin/env bash
# Roda N repetições do cenário 3 MSG com restart completo entre cada uma.
# Uso: ./run-msg-cenario3.sh <repeticoes>
set -euo pipefail
...
echo "=== Bateria MSG Cenário 3: $REPS reps, ${RATE} req/s, ${DURATION} ==="
echo ""
...
echo "  sleep 40"
echo "  RATE=50 DURATION=6m ./run-all.sh rest 3 $REPS"
